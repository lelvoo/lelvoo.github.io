...
在某屎黄色论坛PC区，隔三岔五就能看见以上对话。

家里奋战4年的小米盒子眼瞅着大限将至，于是我也买了一台。
...
不愧于“2元路边摊”美名，拼多多上乱七八糟应有尽有，突出一个鱼龙混杂胆大包天。
...
由于N1的**原本用途是挖矿**，而挖矿势必对硬件寿命造成影响，**刷好机的充新货更是来源不明**。
...
不过机器sn码与外包一致，除了有俩手指印并无其它使用痕迹，就连底部的“0元购兑换码”涂层也没刮。
...
必须注意的是，斐讯N1的电视盒子固件，都是由斐讯官方固件修改而来。
...
[视频](https://www.youtube.com/watch?v=EgvOxhO2odA) / [帖子](http://www.mtons.com/content/7926)里已经讲得非常细致，并且提供傻瓜工具打包下载，所以这里不再赘述。

只说注意事项：

1. 准备一只有线鼠标，接入N1盒子**最外侧的USB**；
...
——完全可以用**普通数据线**连接**Windows平板**进行刷机，就像我这样：
...
- **然而贵**。
  一个遥控器在拼多多单卖价格39起跳，已经能买半个N1盒子了。
- **并且丑**。
  毕竟是搭配T1的遥控器，黑色菱角与N1那雪白机身简直两个画风。
...
1. 开机状态下，按下遥控器的电源按钮，盒子会重启，而不是关机或休眠。
2. 盒子冷启动，进入桌面后需要等几秒让遥控器自己连上。
3. 基于官方固件 v2.19 版修改的第三方固件，在初次配对时不会自动连接，需要插上鼠标进入原生Android设置，在蓝牙里进行手动选择。
...
**使用体验与手头的小米盒子无异，而现在休眠盒子+电视关机能用一只遥控器一键同时搞定，反而更加方便。**
...
然而我刷了三个固件，发现[Steam Link](https://play.google.com/store/apps/details?id=com.valvesoftware.steamlink&hl=ja)全都**无法识别**我的ds4手柄，无解，作罢。
...
斐讯N1作为一款原本用来挖矿的“灵车”硬件，却凭借**优秀性能+丰富接口+低廉价格**，作为电视盒子迎来第二春。

**——即使现在全新货从70涨到了90，性价比也依然爆棚。**

如果你的老盒子需要升级，N1简直是不二之选。

因为300内你买不到比这更好的电视盒子，无论是性能，价格，接口还是外观设计。
...
**随着网友[~~瞎几把~~折腾](https://www.right.com.cn/forum/forum.php?mod=viewthread&tid=428599)，N1的可刷固件早就不再局限Android：**
